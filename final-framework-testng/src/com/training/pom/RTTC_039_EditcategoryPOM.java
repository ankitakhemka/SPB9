...
public class RTTC_039_EditcategoryPOM 
{
	private WebDriver driver;
	
	public RTTC_039_EditcategoryPOM(WebDriver driver) 
	{
		this.driver = driver; 
	...
	@FindBy(id="input-meta-title1")
	private WebElement metatagedit;
	
	@FindBy(xpath="//*[@class='btn btn-primary']")
	private WebElement savedit;
	
	@FindBy(xpath="//*[@class='alert alert-success']")
	private WebElement sucsessmsg;
	...
	public void editmetatag(String value)
	{
		this.metatagedit.clear();
		this.metatagedit.sendKeys(value);
	...
	{
		String text=this.sucsessmsg.getText();
		return text;
	}
